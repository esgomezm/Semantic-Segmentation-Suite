...
# parser.add_argument('--dataset', type=str, default="D:\MarinaCalzada\3dprotucell\CamVid", help='Dataset you are using.')
parser.add_argument('--dataset', type=str, default="/content/gdrive/My Drive/TFG/Seg_github/CamVid", help='Dataset you are using.')
